...
fetch('https://content.jusaninvest.kz/pifs/by-slug/allem')
.then(response => response.json())
.then(data => {
  datasets.forEach((item, index) => {
    datasets[index].datasets[0].data =  [100-data.assetsAllocation.barChart[index].value, data.assetsAllocation.barChart[index].value]
  })
