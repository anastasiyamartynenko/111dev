document.addEventListener('DOMContentLoaded', function() {
    ...
    async function displayData() {
     ...
     jsonData.assetsAllocation.pieChart1.forEach((item, index) => {
      ...
      // Дата
      const dostarDateString = jsonData.income.date + ' ж деректер';
      const dostarDateElement = document.getElementById('dostar-date-kz');
      ...
      if (parseInt(threeMonthsString) < 0) {
      ...
      if (parseInt(fromBeginningString) < 0) {
