document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchJSONData() {
      const response = await fetch('https://content.jusaninvest.kz/pifs/by-slug/allem');
    ...
    // Get a reference to the container element
        ...
        // Дата
        const allemDateString = jsonData.income.date + ' деректер';
        const allemDateElement = document.getElementById('allem-date');
    ...
    //   turkVolkswagenElement.innerHTML = turkVolkswagenString
        ...
        const priceDateElement = document.getElementById('allem-price-date')
        priceDateElement.innerHTML = priceDateString
        // 1 месяц
        const oneMonthString = jsonData.income.oneMonth
        const oneMonthElement = document.getElementById('allem-one-month-with-dividends')
        ...
        const threeMonthsElement = document.getElementById('allem-three-months-with-dividends')
        ...
        const halfYearElement = document.getElementById('allem-half-year-with-dividends')
        ...
        const yearElement = document.getElementById('allem-year-with-dividends')
        ...
        const fromBeginningElement = document.getElementById('allem-from-beginning-with-dividends');      
